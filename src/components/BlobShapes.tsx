    ...
    return (
      <>
        ...
        <svg className="absolute -left-16 top-1/3 w-[300px] h-[300px] opacity-15 animate-float delay-300" viewBox="0 0 300 300" fill="none">
          <path d="M200 50C250 100 280 170 240 230C200 290 120 300 60 260C0 220 -10 140 30 80C70 20 150 0 200 50Z" fill="hsl(40, 90%, 55%)" />
        </svg>
        {/* Small navy circle */}
        ...
        {/* Gold dot */}
        <div className="absolute top-[55%] right-[10%] w-3 h-3 rounded-full bg-gold/40 animate-float delay-500" />
      </>
    );
  }
  ...
  if (variant === "light") {
    return (
      <>
        ...
        {/* Gold ring */}
        <div className="absolute bottom-[10%] left-[4%] w-24 h-24 rounded-full border-2 border-gold/10 animate-float delay-200" />
        {/* Tiny navy dot */}
  ...
  if (variant === "cta") {
    return (
      <>
        ...
        <div className="absolute bottom-[12%] left-[6%] w-16 h-16 rounded-full bg-gold/15 animate-float delay-200" />
        {/* Teal ring */}
